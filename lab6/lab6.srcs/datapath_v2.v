...
module datapath_v2 (
    ...
    hazard_v2 hazard_unit (.ifid_use_rs(ifid_use_rs),
    ...
    assign ifid_target = ifid_branch ? ifid_pcplusone + ifid_extimm : ifid_jump ? {ifid_pc[15:12], ifid_ir[11:0]} : ifid_jmpr ? ifid_forward1 : ifid_pcplusone;
