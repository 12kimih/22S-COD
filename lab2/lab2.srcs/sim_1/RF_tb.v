...
module RF_tb;
    ...
    task check_partial;
        ...
        begin
            ...
            if ((ans[`WORD_SIZE * (0 + 1) - 1:`WORD_SIZE * (0)] == r_data[0] || (A == C) && r_data[0] === data) && (ans[`WORD_SIZE * (1 + 1) - 1:`WORD_SIZE * (1)] == r_data[1]) || (B == C) && r_data[1] === data) begin
                read_all_regs;

                if (ans[`WORD_SIZE * 3 - 1:`WORD_SIZE * 2] == reg_wires[C]) begin
                    success = 1;
                end
            end
